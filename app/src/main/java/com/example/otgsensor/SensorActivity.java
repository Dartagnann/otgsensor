...
import com.example.otgsensor.MyDatabaseHelper;
...
public class SensorActivity extends AppCompatActivity {
    ...
    Button button_begin,button_stop,button_upload,button_save,button_reset,bt_temp,bt_humi,bt_co2,bt_illu,bt_soil_t,bt_soil_h,bt_ph;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bt_co2 = (Button) findViewById(R.id.bt_co2);
        bt_illu = (Button) findViewById(R.id.bt_illu);
        bt_soil_t=findViewById(R.id.bt_soil_t);
        bt_soil_h = (Button) findViewById(R.id.bt_soil_h);
        ...
        addData.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                String co21 = textView3.getText().toString();
                ...
                String ph1 = textView7.getText().toString();
                String longitude1 = longitudeText.getText().toString();
                String latitude1 = latitudeText.getText().toString();
                float tem = Float.parseFloat(temp1);
                float humi = Float.parseFloat(humidity1);
                float co2 = Float.parseFloat(co21);
    ...
    private void upLoad(String posturl,final String temp1, String humidity1, String pressure1, String illumination1, String soilt1, String soilh1, String uv1, String longitude1, String latitude1){
                    ...
                    formBuilder.add("tem", temp1);
                    formBuilder.add("humi", humidity1);
                    formBuilder.add("co2", pressure1);
    ...
    public void setUiEnabled(boolean bool) {
        ...
        bt_co2.setEnabled(bool);
        bt_illu.setEnabled(bool);
        bt_soil_t.setEnabled(bool);
        bt_soil_h.setEnabled(bool);
        bt_ph.setEnabled(bool);
