...
public class LogActivity extends Activity implements View.OnClickListener
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        cardView =  findViewById(R.id.logSignCard);
    ...
    {
        SweetAlertDialog pDialog = new SweetAlertDialog(LogActivity.this, SweetAlertDialog.WARNING_TYPE);
    ...
    {
        final SweetAlertDialog pDialog = new SweetAlertDialog(LogActivity.this, SweetAlertDialog.SUCCESS_TYPE);
        pDialog.getProgressHelper().setBarColor(Color.parseColor("#A5DC86"));
        pDialog.setTitleText(info);
        pDialog.setCancelable(true);
        pDialog.show();
